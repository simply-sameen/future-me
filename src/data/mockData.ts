...
export const DEMO_GOALS: Goal[] = [
  {
    ...
    priority: 3,
    difficulty: 5,
    obstacles: 'Finding product-market fit, managing time alongside a full-time job, and building a user base from zero.',
    motivation: 'Financial freedom for my family and the ability to work on something I truly care about.',
    subGoals: [
  ...
  },
  {
    ...
    priority: 2,
    difficulty: 4,
    obstacles: 'Information overload, keeping up with rapidly changing frameworks, and imposter syndrome.',
    motivation: 'Unlock higher-paying career opportunities and gain confidence to build my own products.',
    subGoals: [
  ...
  },
  {
    ...
    priority: 1,
    difficulty: 3,
    obstacles: 'Staying consistent during busy weeks, avoiding junk food cravings, and recovering from minor injuries.',
    motivation: 'Live a long, energetic life and set a healthy example for my future children.',
    subGoals: [
