      ...
      >
        ...
        <div className="text-center mb-6 mt-2">
          ...
          <h2 className="text-2xl font-black tracking-tight mb-1 text-foreground">
            {isSignUp ? 'Join Future Me' : 'Welcome Back'}
          </h2>
          <p className="text-muted-foreground text-sm">
            {isSignUp ? 'Create your account to start tracking.' : 'Sign in to access your goals.'}
          </p>
        </div>
        ...
        <button
          onClick={handleDemo}
          className="w-full h-12 rounded-xl text-sm font-bold flex items-center justify-center gap-2 mb-6 btn-primary transition-opacity"
        >
        ...
        <Button
          variant="outline"
          className="w-full h-10 text-sm font-medium border-border bg-transparent text-foreground hover:bg-muted flex items-center gap-2"
          onClick={handleDemo}
        >
